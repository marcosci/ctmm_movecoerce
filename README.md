# MoveStack to ctmm Telemetry List
...
## Description
MoveStack to ctmm Telemetry List provides functionality to coerce the MoveStack object from the R package move to a telemetry list from the R package ctmm. This can be useful for analyzing animal movement data using the ctmm package.
